...
<style>@media (max-width: 767.98px) { .border-sm-start-none { border-left: none !important; } }</style>
            ...
            <div class="row">
              <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                <div class="bg-image hover-zoom ripple rounded ripple-surface">
                  <img src="<?php echo URLROOT; ?>/images/pexels-pixabay-68737.jpg"
                    class="w-100" />
                  <a href="#!">
              ...
              <div class="col-md-6 col-lg-6 col-xl-6">
                <h5 style="color:#0d6efd;"> monocoque Dufour 470</h5>
                <h5>3 Nights</h5>
                ...
                <P>September 18-20, 2022</P>
                </div>
                <div class="mb-2 text-muted small">
                <div style="    display: flex;
  justify-content: space-between;" class="card-text"><svg viewBox="0 0 24 24" width="24" height="24">
          ...
          <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
              ...
              <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                <div class="d-flex flex-row align-items-center mb-1">
                  <h4 class="mb-1 me-1">$1300.99</h4>
                  <span class="text-danger"><s>$20000.99</s></span>
                </div>
                <h6 class="text-success">Free restauration</h6>
                <div class="d-flex flex-column mt-4">
                  <button class="btn btn-primary btn-sm" type="button"onclick="openPopup()">Reserver</button>
...
<style>
  ...
  <div  class="container-fluid my-5  popup" id="popup">
          ...
          <div class="row justify-content-around">
            <div class="col-md-5">
              <div class="card border-0">
                <div class="card-header pb-0">
                  <h2 class="card-title space  " style="color: #0d6efd;">monocoque Dufour 470</h2>
                  <h1 class="card-text text-muted mt-4  space">3 NIGHTS</h1>
                  <hr class="my-0">
                </div>
                <div class="card-body">
                ...
                <div class="card-body pt-0">
                  <div class="optionbox">
                    ...
                    <select>
                      ...
                      <option>ROOM DOUBLE DELUXE</option>
                      <option>ROOM DOUBLE ECONOMIQUE</option>
                      <option>ROOM INDIVIDUELLE ECONOMIQUE</option>
                      <option>ROOM INDIVIDUELLE DELUXE</option>
                      <option>ROOM FAMILIALE</option>
                ...
                <div class="row mb-5 mt-4 ">
                  <div class="col-md-7 col-lg-6 mx-auto"><button type="button" class="btn btn-block btn-outline-primary btn-lg">Room Validation</button></div>
                </div>
              </div>
            ...
            <div class="row mt-4">
                  ...
                  <div class="row mb-md-5">
                    <div class="col">
                      <button type="button" name="" id="" class="btn  btn-lg btn-block  btn-primary "> PAYEMENT 1999.99$</button>
                    </div>
                  </div>
            </div>
          </div>
