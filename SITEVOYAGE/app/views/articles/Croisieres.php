          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-6 col-xl-6">
                <h5 style="color:#0d6efd;"><?php echo  $Croisieres->ID_navire ;?></h5>
                <h5>3Nights</h5>
            ...
            <a class="btn btn-primary btn-sm" href="<?php echo URLROOT; ?>/articles/detaille/<?php echo $Croisieres->ID_croisiere ; ?>">Reserver </a>
