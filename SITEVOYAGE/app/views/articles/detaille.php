        ...
        <div class="row justify-content-around">
          <div class="col-md-5">
            <div class="card border-0">
              <div class="card-header pb-0">
                <h2 class="card-title space  " style="color: #0d6efd;"><?php echo $data['Croisieres']->ID_navire;?></h2>
                ...
                <div class="row justify-content-between">
                  <div class="col-auto mt-0">
                    ...
                    <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36">
                      ...
                      <h4><?php echo  $data['Croisieres']->ID_navire;?> VOYAGEUR</h4>
                    </div>
                  </div>
                </div>
                <div class="card border-0 ">
          ...
          <div class="col-md-5">
            ...
            <div class="row mb-md-5">
              <div class="col">
                <button type="button" name="" id="" class="btn  btn-lg btn-block  btn-primary "> PAYEMENT <?php echo $data['Croisieres']->prix_croisiere ;?>$</button>
              </div>
            </div>
          </div>
        </div>
