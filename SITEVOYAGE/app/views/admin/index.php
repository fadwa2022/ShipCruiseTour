            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo URLROOT; ?>/pages/index">Home</a>
                        <a class="collapse-item" href="<?php echo URLROOT; ?>/pages/croisieres">Croisières</a>
                        <a class="collapse-item" href="<?php echo URLROOT; ?>/pages/navire">Navire</a>
                    </div>
            </li>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$data['numbrusers']->cnt?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$data['chiffre_affaire']->cnt?></div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> nombre de ports
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?=$data['nbrport']->cnt?></div>
                                                </div>
                                                <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            nombre total des croisières</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$data['numbrCroisieres']->cnt?></div>
                                        </div>
                                        <div class="col-auto">
