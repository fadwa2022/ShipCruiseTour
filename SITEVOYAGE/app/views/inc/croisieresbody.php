...
<!-- Background image -->
<div class="p-5 text-center bg-image" id="bg-images" style="background-image: url('<?php echo URLROOT; ?>/images/ishan-seefromthesky-Fj_39H4NeOo-unsplash.jpg');
    height: 400px;
    width:100%;
                    ...
                    <form>
                        <div class="inner-form">
                            ...
                            <div class="input-field third-wrap">
                                ...
                                <input class="datepicker" id="return" type="text" placeholder="30 Aug 2023" />
                            </div>
